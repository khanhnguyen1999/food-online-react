    ...
    <>
      {
        food && food.map((item: any) => (
          <FormControl key={item.id}>
            ...
            <img className="image_food" src={checkURL(item.url) ? item.url : "https://shareprogramming.net/wp-content/plugins/accelerated-mobile-pages/images/SD-default-image.png"} alt="Food" />
